#coding: UTF-8
class Admin::Faculty::Chair::GroupController < ApplicationController
  ...
  def new
    if request.post?
      ...
      if group.save
        redirect_to :controller => '/admin/faculty/chair/group', :action => 'index', :faculty_id => params[:faculty_id], :chair_id => params[:chair_id]
      else
