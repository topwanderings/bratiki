...
JSListBox.Item = Class.extend({
	...
	render: function() {
		return '<a href="#">' + this.text + '</a>'; //this allows painting to be overridden in classes which extend JSListBox.Item
	},
	
	onClick: function() {
        $.post('/teacher/parameter/listbox.js', { name_entity: this.text })
	},
	onDblClick: function() {
